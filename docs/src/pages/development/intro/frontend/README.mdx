...
- `src/components/algolia/` - see `Algolia.mdx` if needed
- `src/sites/` - per-site `theme`, `routes`, `layout`, `redirects` selected by build-time `env.VITE_SITE`. See [Sub-sites doc](Sub-sites-with-VITE_SITE.mdx).
...
- [How to structure a React Component](./React-component-structure.mdx)
- [How to use GraphQL](./GraphQL.mdx)
- [How to use Playwright](./Playwright.mdx)
- [How to use Chakra UI](Chakra-UI.mdx)
- [How to work with sub-sites as `VITE_SITE="pg"`](Sub-sites-with-VITE_SITE.mdx) from `src/sites/`
- [Prerender + prefetch](Prerender-and-Prefetch.mdx) — build-time static HTML for SEO without SSR
