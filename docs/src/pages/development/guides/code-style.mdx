...
- <TagLg>#AI</TagLg> - not fully reviewed LLM code → consider dangerous.
- <TagLg>#AI-slop</TagLg> - trash to drop.
- <TagLg>#bad-infer</TagLg> - broken TS type inference - over time check if they fixed it.
- <TagLg>#prob-redundant</TagLg> - may not be useful, but removal isn't a priority.
- <TagLg>#draft</TagLg> - not tested, not working, or not ready for prod.
- <TagLg>#E2E-fails</TagLg> - can be added to Git commit body (as we lack E2E CI atm).
