...
`<scope>` see the <LinkInt path="/development/guides/git-commits">Git commit Scopes</LinkInt>.
...
`<tags>` see the [code-style.md Tags](/docs/src/pages/development/how-to/code-style.mdx#tags).
