...
- `apps`
  ...
  - `site` - `apps.sites`
- `upgrade[<uv|pnpm>]` - pyproject.toml, package.json, lock files, or related changes
- `uv`/`pnpm` - FE/BE dependencies
...
Added at the end of a commit first line. See <LinkInt path="/development/guides/code-style" hash="tags">Tags</LinkInt>.
