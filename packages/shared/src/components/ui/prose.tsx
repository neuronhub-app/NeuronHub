...
/**
 * Mostly chakra-ui defaults.
 *
 * For changes see the "#overriden" tags.
 */
export function getProseBaseStyle<P extends RecipeVariantRecord>(): RecipeDefinition<P> {
  const padding = "0.5em";
  const plListIcon = 0;
