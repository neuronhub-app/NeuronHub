...
export type introspection_types = {
    ...
    'Query': { kind: 'OBJECT'; name: 'Query'; fields: { 'tool': { name: 'tool'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'ToolType'; ofType: null; }; } }; 'tools': { name: 'tools'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'ToolType'; ofType: null; }; }; }; } }; 'user_current': { name: 'user_current'; type: { kind: 'OBJECT'; name: 'UserType'; ofType: null; } }; }; };
    'String': unknown;
