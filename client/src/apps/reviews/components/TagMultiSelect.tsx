    ...
    <Flex>
      <AsyncCreatableSelect
        ...
        styles={{
          control: styles => ({
            ...styles,
            backgroundColor: system.token("colors.gray.200"),
            borderColor: system.token("colors.gray.100"),
          }),
          multiValue: styles => ({
            ...styles,
            ...(system.css({
              color: "white",
              bg: "gray.100",
            }) as any), // types don't work properly here
          }),
        }}
        theme={theme => ({
          ...theme,
          colors: {
            ...theme.colors,
            primary: system.token("colors.gray.100"),
            primary75: "#4C9AFF",
            primary50: "#B2D4FF",
            primary25: "#DEEBFF",
            danger: "#DE350B",
