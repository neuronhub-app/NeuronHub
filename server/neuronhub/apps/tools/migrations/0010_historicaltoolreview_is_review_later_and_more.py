            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="tools.tooltagrating",
                    ),
                ),
                (
                    "tools",
                    models.ManyToManyField(
                        blank=True, related_name="tags_rating", to="tools.tool"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tag",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="tools.tooltagrating"
                    ),
                ),
                (
                    "tool",
